...
html_content = f"""<div style="background:0 0;margin:0;padding:0;border:0 none transparent;outline:0 none transparent;width:100%;height:auto;box-sizing:border-box">
  <table width="100%" cellspacing="0" cellpadding="0" style="font-size:16px !important;max-width:537px !important;min-width:280px !important;width:96.69% !important">
    <tbody>
      <tr>
        <td align="left">
          <table width="100%" cellspacing="0" cellpadding="0" border="0" style="font-family:Helvetica,system-ui,sans-serif;font-size:clamp(.5em,2.353vw + .059em,1em)!important;line-height:clamp(.4em,6.588vw + -.835em,1.8em)!important;padding:0 clamp(1.125em,3.882vw + .397em,1.95em) 0!important;color:#0061ba!important;text-align:left;word-spacing:normal;letter-spacing:normal">
            <tbody>
              <tr>
                <td>
                  <div style="margin:clamp(1.125em,3.882vw + .397em,1.95em) auto 0;font-size:0.96em;">
                    ...
                    <table style="border-collapse:collapse;width:100%;font-family:Helvetica,system-ui,sans-serif;font-size:0.96em;color:#0061ba!important;">
                        {table_rows}
                    </table>
                    <p>
                      <br>
              ...
              <tr>
                <td>
                  <div style="border:0 none transparent;border-top:.032em dashed rgba(0,97,186,.69);width:90%;margin:clamp(1.125em,3.882vw + .397em,1.95em) auto"></div>
                  <p>Best regards,</p>
                </td>
              </tr>
              <tr>
                <td align="center">
                  <a href="https://www.hcc.com.ph/" style="display:block;text-decoration:none" target="_blank">
                    <img src="https://raw.githubusercontent.com/MasterZeeno/Repository/main/zee-signature.png" alt="Jay Ar Adlaon Cimacio, RN, OHN" width="100%" height="auto" style="display:block;max-width:100%;height:auto;border:none">
                  </a>
                </td>
              </tr>
            </tbody>
